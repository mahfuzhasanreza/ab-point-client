...
export default function MediaCoverageSection() {
    ...
    const youtubeNews = [
        {
            id: 1,
            title: "UIU CanSat Team Prepares for NASA Competition 2026",
    ...
    const newsArticles = [
        ...
        },
        {
            ...
            excerpt: "The UIU CanSat team represents the future of aerospace engineering in Bangladesh, showcasing local talent on the global stage...",
